...
export class GroupComponent implements OnInit {
  ...
  groupData2: any = {
    ...
    groupName: 'Racial Equity in Infrastructure, a U.S. Goal, Is Left to States',
    userName: 'Torrie Wilson',
    postDate: 'Yesterday at 09:23',
    postDesc: 'President Biden’s $1 trillion plan to rebuild America’s infrastructure comes with a built-in promise: No longer will roads, bridges and railways be instruments of bias or racism. Communities that ended up divided along racial lines will be made whole.',
